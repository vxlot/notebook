...
dataset = load_dataset("yuvalkirstain/pickapic_v2", split="train")
...
print(dataset.data['train'].column_names)
print(dataset.data['train']['caption'][0])

im_scalar = dataset.data['train']['jpg_0'][0]  
